...
export default function InputExamplesPage() {
  ...
  return (
    <div className='flex flex-col gap-y-4 mt-8 mb-8'>
      ...
      <div className='flex flex-col gap-y-4 items-center'>
        <RoundedInputWithIcon value={largeRoundedInputWithIconValue} onChange={(e) => setLargeRoundedInputWithIconValue(e.target.value)} size='L' Icon={<SearchIcon />} placeholder='Label' disabled={true} />
        <RoundedInputWithIcon value={mediumRoundedInputWithIconValue} onChange={(e) => setMediumRoundedInputWithIconValue(e.target.value)} size='M' Icon={<SearchIcon />} placeholder='Label' />
        <RoundedInputWithIcon value={smallRoundedInputWithIconValue} onChange={(e) => setSmallRoundedInputWithIconValue(e.target.value)} size='S' Icon={<SearchIcon />} placeholder='Label' />
      </div>
      <div className='flex flex-col gap-y-4 items-center'>
      ...
      <div className='flex flex-col gap-y-4 items-center'>
        <SquareInputWithIcon value={largeSquareInputWithIconValue} onChange={(e) => setLargeSquareInputWithIconValue(e.target.value)} size='L' Icon={<SearchIcon />} placeholder='Label' disabled={true} />
        <SquareInputWithIcon value={mediumSquareInputWithIconValue} onChange={(e) => setMediumSquareInputWithIconValue(e.target.value)} size='M' Icon={<SearchIcon />} placeholder='Label' />
        <SquareInputWithIcon value={smallSquareInputWithIconValue} onChange={(e) => setSmallSquareInputWithIconValue(e.target.value)} size='S' Icon={<SearchIcon />} placeholder='Label' />
      </div>
      <div className='flex flex-col gap-y-4 items-center'>
        <SquareInputWithMax value={largeSquareInputWithMaxValue} onChange={(e) => setLargeSquareInputWithMaxValue(e.target.value)} size='L' placeholder='Label' onMaxClick={() => console.log('hi')} disabled={true} />
        <SquareInputWithMax value={mediumSquareInputWithMaxValue} onChange={(e) => setMediumSquareInputWithMaxValue(e.target.value)} size='M' placeholder='Label' onMaxClick={() => console.log('hi')} />
        <SquareInputWithMax value={smallSquareInputWithMaxValue} onChange={(e) => setSmallSquareInputWithMaxValue(e.target.value)} size='S' placeholder='Label' onMaxClick={() => console.log('hi')} />
      </div>
    </div>
  );
}
